...
// var url = "https://www.pwc.in/about-us/people-at-pwc.html";
// var question = "Tell me about hetal from Pwc?"
var url,question
...
url = myPrompt("Enter URL:");
question=myPrompt("Ask Question:")
...
async function handleHTML_TV(html) {
  ...
  plainText=plainText.substring(headers,headers+Math.min(max_chars,plainText.length))
...
async function handleHTML_CR(html){
  ...
  // Ask Question from the parsed text
  // console.log("Question: "+ question)
  question="Write a detailed answer after understanding the above passage. "+question
